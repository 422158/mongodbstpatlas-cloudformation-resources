...
<pre>
{
    "Type" : "MongoDB::StpAtlasV1::EncryptionAtRest",
    "Properties" : {
...
When you pass the logical ID of this resource to the intrinsic `Ref` function, Ref returns the CfnPrimaryIdentifier.
...
Encryption at rest resource identifier based of projectId
